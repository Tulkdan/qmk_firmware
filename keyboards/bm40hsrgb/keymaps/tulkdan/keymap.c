...
[_LOWER] = LAYOUT_planck_mit(
    ...
    KC_DEL,  KC_PSCR, C_S_T(KC_PSCR), _______, _______, _______, _______, KC_UNDS,       KC_PLUS,       KC_LCBR, KC_RCBR, KC_PIPE,
    _______, _______, _______,        _______, _______, _______, _______, LSFT(KC_NUHS), LSFT(KC_NUBS), KC_HOME, KC_END,  _______,
